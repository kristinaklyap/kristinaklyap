...
- **UI Kit**: A comprehensive set of UI components built with React, Redux Toolkit, and SCSS. [GitHub Repository](https://github.com/kristinaklyap/ui-kit)
- **Portfolio Website**: My personal portfolio showcasing my projects and skills, developed with TypeScript and React. [GitHub Repository](https://github.com/kristinaklyap/portfolio-ts)
